const translations = {
	en: {
		...
		content: {
			...
			paragraph1: "<em>Resistance in Belgium</em> is the result of a pilot project run by CegeSoma/State Archives of Belgium. This platform enables research into thousands of people involved in <b>resistance activities during the Second World War in Belgium</b> or, in some cases, in neighbouring countries such as France in particular. It currently contains information on more than <b>42,000 people</b>, representing <b>around a quarter of all resistance members</b>. These are individuals for whom a file related to Intelligence and Intervention Services was produced by the State Security Service (Sûreté de l’État/Staatsveiligheid). <a href=\"/wiki/Data/en\" style=\"color: #158f68;\">New data</a> will be added regularly.",
			paragraph2: "<h5>Transversal search</h5>Would you like to carry out more advanced search queries, for example based on the municipality of residence or the membership in a resistance organisation? See our page on transversal search for more information.",
	...
	fr: {
		...
		content: {
			...
			paragraph1: "<em>Resistance in Belgium</em> est le fruit d’un projet pilote mené par le CegeSoma/Archives de l’État en Belgique. Cette plateforme vous permet d’effectuer des recherches sur les milliers de personnes impliquées dans des <b>activités de résistance durant la Seconde Guerre mondiale en Belgique</b> ou, dans certains cas, dans des pays voisins, en particulier la France. Actuellement, elle contient des informations sur plus de <b>42 000 personnes</b>, soit <b>environ un quart des résistant·e·s</b>. Il s'agit des personnes pour lesquelles un dossier en lien avec les services de Renseignements et d’Action a été produit par la Sûreté de l’État. De <a href=\"/wiki/Data/fr\" style=\"color: #158f68;\">nouvelles données</a> seront régulièrement ajoutées.",
	...
	de: {
		...
		content: {
			...
			paragraph1: "<em>Resistance in Belgium</em> ist das Ergebnis eines vom CegeSoma/Belgisches Staatsarchiv durchgeführten Pilotprojekts. Die Plattform ermöglicht die Suche nach Tausenden von Personen, die <b>während des Zweiten Weltkriegs in Belgien in Widerstandsaktivitäten aktiv waren</b> oder in einigen Fällen auch in Nachbarländern, insbesondere in Frankreich. Derzeit enthält die Datenbank Informationen über mehr als <b>42.000 Personen</b>, was <b>etwa einem Viertel der Widerstandskämpfer</b> entspricht. Es handelt sich um Personen, für die von der Staatssicherheit eine Akte im Zusammenhang mit den Diensten für Nachrichten- und Aktionstätigkeiten erstellt wurde. <a href=\"/wiki/Data/en\" style=\"color: #158f68;\">Neue Daten</a> werden regelmäßig hinzugefügt.",
			paragraph2: "<h5>Erweiterte Suche</h5>Möchten Sie umfassendere Nachforschungen durchführen, z. B. auf der Grundlage des Wohnorts einer Person oder Mitgliedschaft in Widerstandsorganisationen? Besuchen Sie unsere Seite zur erweiterten Suche für zusätzliche Informationen.",
